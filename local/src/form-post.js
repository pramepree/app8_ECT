    ...
    return (
        <div style={{ margin: '30px' }}>
            <form ref={form} onSubmit={onSubmitForm}>
                ...
                <input type="text" name="email" size="43" placeholder="อีเมล" style={inputStyle}></input><br />
                <textarea type="text" name="message" cols="40" rows="4" placeholder="ข้อความ" style={inputStyle}></textarea><br />
                <button>ตกลง</button>
            </form>
            <br />
